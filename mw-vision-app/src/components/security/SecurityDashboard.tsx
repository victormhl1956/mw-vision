      ...
      <div className="bg-osint-panel border border-osint-cyan/30 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-osint-cyan/20">
          <div className="flex items-center gap-6">
            <div className={`w-24 h-24 rounded-full ${getScoreBg(metrics.score)} flex items-center justify-center border-2 ${
              metrics.score >= 90 ? 'border-green-500' : metrics.score >= 70 ? 'border-yellow-500' : 'border-red-500'
            }`}>
